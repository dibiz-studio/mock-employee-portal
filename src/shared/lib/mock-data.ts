...
export const MOCK_LEAVE_REQUESTS = [
  ...
  { id: "lr-7", employee_id: "14", employee_name: "Yash", policy_id: "lp-3", policy_name: "Earned Leave", start_date: "2026-06-18", end_date: "2026-06-19", days_requested: 2, reason: "Family travel", status: "APPROVED", reviewed_by: "1", reviewed_at: "2026-06-15T12:00:00.000Z", review_notes: "Enjoy the time off", created_at: "2026-06-14T09:45:00.000Z" },
  { id: "lr-8", employee_id: "6", employee_name: "Simran Gaikwad", policy_id: "lp-2", policy_name: "Sick Leave", start_date: "2026-06-20", end_date: "2026-06-20", days_requested: 1, reason: "Doctor appointment", status: "APPROVED", reviewed_by: "1", reviewed_at: "2026-06-19T15:30:00.000Z", review_notes: "Approved", created_at: "2026-06-19T09:00:00.000Z" },
  { id: "lr-9", employee_id: "3", employee_name: "Riya Paithankar", policy_id: "lp-2", policy_name: "Sick Leave", start_date: "2026-06-24", end_date: "2026-06-25", days_requested: 2, reason: "Migraine and rest", status: "PENDING", reviewed_by: null, reviewed_at: null, review_notes: null, created_at: "2026-06-21T11:15:00.000Z" },
  { id: "lr-10", employee_id: "11", employee_name: "Ritikesh", policy_id: "lp-4", policy_name: "Loss of Pay", start_date: "2026-06-26", end_date: "2026-06-26", days_requested: 1, reason: "Personal errand", status: "PENDING", reviewed_by: null, reviewed_at: null, review_notes: null, created_at: "2026-06-22T08:20:00.000Z" },
  { id: "lr-11", employee_id: "13", employee_name: "Saniya", policy_id: "lp-1", policy_name: "Casual Leave", start_date: "2026-06-28", end_date: "2026-06-28", days_requested: 1, reason: "College event", status: "PENDING", reviewed_by: null, reviewed_at: null, review_notes: null, created_at: "2026-06-23T10:00:00.000Z" },
];
...
export const MOCK_KPI_TEMPLATES = [
  ...
  { id: "kpit-7", name: "Revision Turnaround", description: "Average time to close client revisions", category: "Quality", measurement_unit: "Hours", default_target: 24, period: "MONTHLY", department_id: "dept-1", department: { id: "dept-1", name: "Video Editing", code: "VE" }, weight: 25, is_active: true, created_at: "2025-02-01T00:00:00.000Z" },
  { id: "kpit-8", name: "Campaign Launch Readiness", description: "Percentage of launches ready before deadline", category: "Delivery", measurement_unit: "%", default_target: 95, period: "MONTHLY", department_id: "dept-2", department: { id: "dept-2", name: "Social Media Marketing", code: "SMM" }, weight: 35, is_active: true, created_at: "2025-02-01T00:00:00.000Z" },
  { id: "kpit-9", name: "Bug Fix Turnaround", description: "Average time to close internal issues", category: "Operations", measurement_unit: "Hours", default_target: 12, period: "MONTHLY", department_id: "dept-4", department: { id: "dept-4", name: "Technology", code: "TECH" }, weight: 30, is_active: true, created_at: "2025-02-01T00:00:00.000Z" },
  { id: "kpit-10", name: "Knowledge Sharing Sessions", description: "Internal skill-sharing sessions run per month", category: "Culture", measurement_unit: "Sessions", default_target: 2, period: "MONTHLY", department_id: null, department: null, weight: 15, is_active: true, created_at: "2025-02-01T00:00:00.000Z" },
];
...
export const MOCK_EMPLOYEE_KPIS = [
  ...
  { id: "ekpi-9", employee_id: "3", template_id: "kpit-7", title: "Revision Turnaround - June 2026", description: "Average client revision closure time", target_value: 24, current_value: 18, unit: "Hours", weight: 25, period: "MONTHLY", period_start: "2026-06-01", period_end: "2026-06-30", status: "ON_TRACK", notes: "Turnaround improving", created_at: "2026-06-01T00:00:00.000Z", employee: { id: "3", full_name: "Riya Paithankar", avatar_url: null }, template: { name: "Revision Turnaround", category: "Quality" } },
  { id: "ekpi-10", employee_id: "4", template_id: "kpit-5", title: "Graphic Deliverables - June 2026", description: "Creatives delivered in June", target_value: 25, current_value: 19, unit: "Creatives", weight: 40, period: "MONTHLY", period_start: "2026-06-01", period_end: "2026-06-30", status: "ON_TRACK", notes: "Steady output", created_at: "2026-06-01T00:00:00.000Z", employee: { id: "4", full_name: "Manshi Rathi", avatar_url: null }, template: { name: "Graphic Deliverables", category: "Production" } },
  { id: "ekpi-11", employee_id: "5", template_id: "kpit-1", title: "VE Intern Output - June 2026", description: "Reels edited by Vinisha in June", target_value: 18, current_value: 13, unit: "Reels", weight: 30, period: "MONTHLY", period_start: "2026-06-01", period_end: "2026-06-30", status: "AT_RISK", notes: "Need to catch up on queued edits", created_at: "2026-06-01T00:00:00.000Z", employee: { id: "5", full_name: "Vinisha", avatar_url: null }, template: { name: "Monthly Video Output", category: "Production" } },
  { id: "ekpi-12", employee_id: "9", template_id: "kpit-9", title: "Tech Bug Fix Turnaround - June 2026", description: "Average turnaround for internal tech issues", target_value: 12, current_value: 10, unit: "Hours", weight: 30, period: "MONTHLY", period_start: "2026-06-01", period_end: "2026-06-30", status: "ON_TRACK", notes: "Quick response time", created_at: "2026-06-01T00:00:00.000Z", employee: { id: "9", full_name: "Purva", avatar_url: null }, template: { name: "Bug Fix Turnaround", category: "Operations" } },
  { id: "ekpi-13", employee_id: "10", template_id: "kpit-10", title: "Knowledge Sharing Sessions - June 2026", description: "Internal sessions run for the team", target_value: 2, current_value: 1, unit: "Sessions", weight: 15, period: "MONTHLY", period_start: "2026-06-01", period_end: "2026-06-30", status: "IN_PROGRESS", notes: "Second session planned", created_at: "2026-06-01T00:00:00.000Z", employee: { id: "10", full_name: "Chirag", avatar_url: null }, template: { name: "Knowledge Sharing Sessions", category: "Culture" } },
  { id: "ekpi-14", employee_id: "11", template_id: "kpit-9", title: "Internal Issue Turnaround - June 2026", description: "Average time to close internal bugs", target_value: 12, current_value: 14, unit: "Hours", weight: 30, period: "MONTHLY", period_start: "2026-06-01", period_end: "2026-06-30", status: "AT_RISK", notes: "A few issues are waiting on review", created_at: "2026-06-01T00:00:00.000Z", employee: { id: "11", full_name: "Ritikesh", avatar_url: null }, template: { name: "Bug Fix Turnaround", category: "Operations" } },
  { id: "ekpi-15", employee_id: "14", template_id: "kpit-8", title: "Launch Readiness - June 2026", description: "Campaign assets ready before deadline", target_value: 95, current_value: 96, unit: "%", weight: 35, period: "MONTHLY", period_start: "2026-06-01", period_end: "2026-06-30", status: "COMPLETED", notes: "Everything shipped on time", created_at: "2026-06-01T00:00:00.000Z", employee: { id: "14", full_name: "Yash", avatar_url: null }, template: { name: "Campaign Launch Readiness", category: "Delivery" } },
];
...
export const MOCK_NOTIFICATIONS = [
  ...
  { id: "notif-6", user_id: "14", type: "LEAVE_REQUEST", title: "Leave approved", message: "Your earned leave for Jun 18-19, 2026 was approved.", link: "/leave/history", is_read: false, read_at: null, created_at: "2026-06-15T12:05:00.000Z" },
  { id: "notif-7", user_id: "10", type: "SYSTEM", title: "KPI assigned", message: "You were assigned a knowledge sharing KPI for June 2026.", link: "/kpi", is_read: false, read_at: null, created_at: "2026-06-01T09:15:00.000Z" },
  { id: "notif-8", user_id: "1", type: "SYSTEM", title: "Policy updated", message: "Leave policies were updated for the June planning cycle.", link: "/settings/leave", is_read: true, read_at: "2026-06-08T10:00:00.000Z", created_at: "2026-06-08T09:30:00.000Z" },
];
